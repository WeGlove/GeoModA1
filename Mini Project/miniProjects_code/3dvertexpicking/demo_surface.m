...
% Markers
selection_marker = line('marker','o','markerfacecolor','k','visible','off');
selection_vertex = line('marker','o','markerfacecolor','k','visible','off');
selection_face = line('marker','o','markerfacecolor','k','visible','off');
